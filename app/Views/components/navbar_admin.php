...
<nav class="navbar navbar-expand navbar-light shadow-sm mb-3 px-3 sticky-top floating-navbar glass-navbar"
    ...
    <div class="container-fluid justify-content-between align-items-center">
        ...
        <div class="d-flex align-items-center gap-3 ms-auto">
            <a href="<?= base_url('admin/notifikasi') ?>" class="position-relative text-decoration-none me-2">
            ...
            <div class="dropdown">
                <a class="d-flex align-items-center text-decoration-none dropdown-toggle" href="#"
                    id="dropdownAdminMenu" data-bs-toggle="dropdown" aria-expanded="false">
                    <?php
                        $foto_profil_admin = session()->get('foto_profil');
                        $foto_path_admin   = $foto_profil_admin ? 'uploads/profil/' . $foto_profil_admin : null;
                    ?>
                    <?php if ($foto_path_admin && file_exists(FCPATH . $foto_path_admin)): ?>
                        <img src="<?= base_url($foto_path_admin) ?>" alt="Foto Profil"
                ...
                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownAdminMenu">
                    <li><a class="dropdown-item" href="<?= base_url('admin/profil') ?>"><i
                                class="bi bi-person me-2"></i> Edit Profil</a></li>
                    <li>
