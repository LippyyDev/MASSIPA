...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url('assets/css/admin/InputTandaTanganAdmin.css') ?>">
...
<body data-flash-msg="<?= esc(session()->getFlashdata('msg')) ?>"
    ...
    <div class="main-content">
        ...
        <div class="container-fluid px-0">
                ...
                <div class="card-header tambah-ttd-header" style="cursor: pointer; user-select: none;">
                    ...
                    <ul class="nav nav-tabs mb-0 mt-2" id="ttdTab" role="tablist" onclick="event.stopPropagation();">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link active" id="ttd-biasa-tab" data-bs-toggle="tab"
                                data-bs-target="#ttd-biasa" type="button" role="tab" aria-controls="ttd-biasa"
                                aria-selected="true">
                                <i class="bi bi-pencil"></i> Tanda Tangan Biasa
                            </button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="ttd-gambar-tab" data-bs-toggle="tab"
                                data-bs-target="#ttd-gambar" type="button" role="tab" aria-controls="ttd-gambar"
                                aria-selected="false">
                            ...
                            <form action="<?= base_url('admin/addTandaTangan') ?>" method="post">
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" id="nama_penandatangan"
                                            name="nama_penandatangan" oninput="this.value = this.value.replace(/[0-9]/g, '')" required>
                                    </div>
                                    <div class="col-md-6">
                                        <label for="nip_penandatangan" class="form-label">NIP Penandatangan</label>
                                        <input type="number" class="form-control" id="nip_penandatangan"
                                            name="nip_penandatangan" pattern="[0-9]*" inputmode="numeric" required>
                                    </div>
                                </div>
                            ...
                            <form method="POST" action="<?= base_url('admin/addTandaTanganGambar') ?>"
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" id="tempat_gambar" name="tempat"
                                            required>
                                    </div>
                                    <div class="col-md-6">
                                        <label for="tanggal_gambar" class="form-label">Tanggal</label>
                                        <input type="date" class="form-control" id="tanggal_gambar" name="tanggal"
                                            value="<?= date('Y-m-d') ?>" required>
                                    </div>
                                </div>
                                <div class="mb-3">
                                    <label for="gambar_ttd" class="form-label">Upload Gambar Tanda Tangan
                                        (PNG/JPG)</label>
                                    <input type="file" class="form-control" id="gambar_ttd" name="gambar_ttd"
                                        accept="image/png, image/jpeg" required>
                                    <div class="form-text">Pastikan gambar jelas dan rapi. Crop akan otomatis sesuai
                                        area gambar.</div>
                                    <img id="preview_gambar_ttd" src="#" alt="Preview"
                                        style="max-width:220px;max-height:80px;display:none;margin-top:10px;border:1px solid #e0e0e0;border-radius:6px;" />
                                </div>
            ...
            <div class="card mb-3">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <ul class="nav nav-tabs mb-0" id="ttdDataTab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link active" id="data-ttd-biasa-tab" data-bs-toggle="tab"
                                data-bs-target="#data-ttd-biasa" type="button" role="tab" aria-controls="data-ttd-biasa"
                                aria-selected="true">
                                <i class="bi bi-table"></i> Tanda Tangan Biasa
                            </button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="data-ttd-gambar-tab" data-bs-toggle="tab"
                                data-bs-target="#data-ttd-gambar" type="button" role="tab"
                                aria-controls="data-ttd-gambar" aria-selected="false">
                                <i class="bi bi-image"></i> Tanda Tangan Gambar
                            </button>
                        </li>
                    </ul>
                ...
                <div class="card-body">
                    <div class="tab-content" id="ttdDataTabContent">
                        <div class="tab-pane fade show active" id="data-ttd-biasa" role="tabpanel"
                            aria-labelledby="data-ttd-biasa-tab">
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($tanda_tangan_data as $row): ?>
                                            <tr>
                                                ...
                                                <td data-label="Lokasi"><?= esc($row['lokasi']) ?></td>
                                                <td data-label="Tanggal"><?= tanggalIndo($row['tanggal']) ?></td>
                                                <td data-label="Nama Jabatan"><?= esc($row['nama_jabatan']) ?></td>
                                                <td data-label="Nama Penandatangan"><?= esc($row['nama_penandatangan']) ?>
                                                </td>
                                                <td data-label="NIP Penandatangan"><?= esc($row['nip_penandatangan']) ?>
                                                </td>
                                                ...
                                                <td data-label="Aksi" class="col-aksi aksi-ttd-biasa">
                                                    <?php if (!$row['is_aktif']): ?>
                                                        <a href="<?= base_url('admin/setAktifTandaTangan/manual/' . $row['id']) ?>"
                                                            class="btn btn-outline-primary btn-sm aksi-btn" title="Aktifkan"><i
                                                                class="bi bi-check-circle"></i></a>
                                                    <?php else: ?>
                                                        <a href="<?= base_url('admin/setAktifTandaTangan/manual/' . $row['id']) ?>"
                                                            class="btn btn-outline-danger btn-sm aksi-btn"
                                                            title="Nonaktifkan"><i class="bi bi-x-circle"></i></a>
                                                    <?php endif; ?>
                                                    <button type="button" class="btn btn-warning btn-sm aksi-btn"
                                                        data-bs-toggle="modal"
                                                        data-bs-target="#editTandaTanganModal<?= $row['id'] ?>"
                                                        title="Edit">
                                                        <i class="fas fa-edit"></i>
                                                    </button>
                                                    <a href="<?= base_url('admin/deleteTandaTangan/' . $row['id']) ?>"
                                                        class="btn btn-danger btn-sm aksi-btn btn-delete-ttd"
                                                        data-nama="<?= esc($row['nama_penandatangan']) ?>" title="Hapus"><i
                                    ...
                                    foreach ($tanda_tangan_data as $row): ?>
                                        <div class="border rounded mb-3 p-3 shadow-sm" style="background:#fff;">
                                            <div class="fw-bold mb-1 d-flex justify-content-between align-items-center">
                                                <span>No. <?= $no++ ?> - <?= esc($row['nama_penandatangan']) ?></span>
                                                <span class="badge bg-<?= $row['is_aktif'] ? 'success' : 'secondary' ?>">
                                                    <?= $row['is_aktif'] ? 'Aktif' : 'Nonaktif' ?>
                                                </span>
                                            </div>
                                            <div><b>Lokasi:</b> <?= esc($row['lokasi']) ?></div>
                                            <div><b>Tanggal:</b> <?= tanggalIndo($row['tanggal']) ?></div>
                                            <div><b>Nama Jabatan:</b> <?= esc($row['nama_jabatan']) ?></div>
                                            <div><b>NIP Penandatangan:</b> <?= esc($row['nip_penandatangan']) ?></div>
                                            <div class="mt-2 d-flex gap-2 flex-wrap">
                                                <?php if (!$row['is_aktif']): ?>
                                                    <a href="<?= base_url('admin/setAktifTandaTangan/manual/' . $row['id']) ?>"
                                                        class="btn btn-outline-primary btn-sm aksi-btn" title="Aktifkan">
                                                        <i class="bi bi-check-circle"></i>
                                                    </a>
                                                <?php else: ?>
                                                    <a href="<?= base_url('admin/setAktifTandaTangan/manual/' . $row['id']) ?>"
                                                        class="btn btn-outline-danger btn-sm aksi-btn" title="Nonaktifkan">
                                                ...
                                                <a href="<?= base_url('admin/deleteTandaTangan/' . $row['id']) ?>"
                                                    class="btn btn-danger btn-sm aksi-btn btn-delete-ttd"
                                                    data-nama="<?= esc($row['nama_penandatangan']) ?>" title="Hapus">
                        ...
                        <div class="tab-pane fade" id="data-ttd-gambar" role="tabpanel"
                            aria-labelledby="data-ttd-gambar-tab">
                            <div class="table-responsive d-none d-md-block">
                                <table class="table table-hover table-borderless align-middle modern-table">
                                    <thead>
                                        <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td data-label="Gambar">
                                                    <?php if (!empty($row['file_path'])): ?>
                                                        <img src="<?= base_url('admin/input_tanda_tangan/getFile/' . urlencode($row['file_path'])) ?>"
                                                            alt="Tanda Tangan Gambar"
                                                            style="max-width:90px; max-height:60px; border:1px solid #ccc; border-radius:6px;">
                                                    <?php endif; ?>
                                                </td>
                                                <td data-label="Status">
                                                    <?php if ($row['is_aktif']): ?>
                                                ...
                                                <td data-label="Aksi" class="col-aksi aksi-ttd-gambar">
                                                    <?php if (!$row['is_aktif']): ?>
                                                        <a href="<?= base_url('admin/setAktifTandaTangan/gambar/' . $row['id']) ?>"
                                                            class="btn btn-outline-primary btn-sm aksi-btn" title="Aktifkan"><i
                                                                class="bi bi-check-circle"></i></a>
                                                    <?php else: ?>
                                                        <a href="<?= base_url('admin/setAktifTandaTangan/gambar/' . $row['id']) ?>"
                                                    ...
                                                    <button type="button" class="btn btn-warning btn-sm aksi-btn"
                                                        data-bs-toggle="modal"
                                                        data-bs-target="#editTandaTanganGambarModal<?= $row['id'] ?>"
                                                        title="Edit">
                                                        <i class="fas fa-edit"></i>
                                                    </button>
                                                    <a href="<?= base_url('admin/deleteTandaTanganGambar/' . $row['id']) ?>"
                                                        class="btn btn-danger btn-sm aksi-btn btn-delete-ttd-gambar"
                                                        data-nama="<?= esc($row['tempat']) ?>"
                                                        title="Hapus">
                                                        <i class="fas fa-trash"></i>
                                                    </a>
                                                </td>
                                        ...
                                        <div class="border rounded mb-3 p-3 shadow-sm" style="background:#fff;">
                                            ...
                                            <?php if (!empty($row['file_path'])): ?>
                                                <div class="mb-2">
                                                    ...
                                                    <img src="<?= base_url('admin/input_tanda_tangan/getFile/' . urlencode($row['file_path'])) ?>"
                                                        alt="Tanda Tangan Gambar"
                                                        style="max-width:120px; max-height:80px; border:1px solid #ccc; border-radius:6px; margin-top:4px;">
                                                </div>
                                            <?php endif; ?>
                                            <div class="mt-2 d-flex gap-2 flex-wrap">
                                                <?php if (!$row['is_aktif']): ?>
            ...
            <?php foreach (($tanda_tangan_gambar_data ?? []) as $row): ?>
                <div class="modal fade" id="editTandaTanganGambarModal<?= $row['id'] ?>" tabindex="-1"
                    aria-labelledby="editTandaTanganGambarModalLabel<?= $row['id'] ?>">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="editTandaTanganGambarModalLabel<?= $row['id'] ?>">Edit Tanda
                                    Tangan Gambar</h5>
                            ...
                            <form method="POST" action="<?= base_url('admin/updateTandaTanganGambar') ?>"
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="tempat_edit_<?= $row['id'] ?>"
                                            name="tempat" value="<?= esc($row['tempat']) ?>" required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="tanggal_edit_<?= $row['id'] ?>" class="form-label">Tanggal</label>
                                        <input type="date" class="form-control" id="tanggal_edit_<?= $row['id'] ?>"
                                            name="tanggal" value="<?= esc($row['tanggal']) ?>" required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="gambar_ttd_edit_<?= $row['id'] ?>" class="form-label">Gambar Tanda
                                            Tangan (Opsional)</label>
                                        <input type="file" class="form-control" id="gambar_ttd_edit_<?= $row['id'] ?>"
                                            name="gambar_ttd" accept="image/png, image/jpeg">
                                        <div class="form-text">Upload gambar baru untuk mengganti gambar yang ada. Kosongkan
                                            jika tidak ingin mengubah gambar.</div>

                                        <img id="preview_gambar_edit_<?= $row['id'] ?>" src="#" alt="Preview"
                                            style="max-width:200px;max-height:100px;display:none;margin-top:10px;border:1px solid #e0e0e0;border-radius:6px;" />
                                    </div>
                                </div>
            ...
            <?php foreach ($tanda_tangan_data as $row): ?>
                <div class="modal fade" id="editTandaTanganModal<?= $row['id'] ?>" tabindex="-1"
                    aria-labelledby="editTandaTanganModalLabel<?= $row['id'] ?>">
                    <div class="modal-dialog">
                        <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="nama_jabatan"
                                            value="<?= esc($row['nama_jabatan']) ?>" oninput="this.value = this.value.replace(/[0-9]/g, '')" required>
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Nama Penandatangan</label>
                                        <input type="text" class="form-control" name="nama_penandatangan"
                                            value="<?= esc($row['nama_penandatangan']) ?>" oninput="this.value = this.value.replace(/[0-9]/g, '')" required>
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">NIP Penandatangan</label>
                                        <input type="number" class="form-control" name="nip_penandatangan"
                                            value="<?= esc($row['nip_penandatangan']) ?>" pattern="[0-9]*" inputmode="numeric" required>
                                    </div>
                                </div>
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
    ...
    <script src="<?= base_url('assets/js/admin/InputTandaTanganAdmin.js') ?>"></script>
