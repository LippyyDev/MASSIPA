...
<body>
    ...
    <div class="center-401">
        <div class="big-401">401</div>
        <div class="notfound-text">Unauthorized!</div>
        <div class="desc-401">
            Anda tidak memiliki otorisasi untuk mengakses halaman ini.
        </div>
        <a href="<?= base_url('login') ?>" class="btn-home">Kembali ke Login</a>
    </div>
    <div class="copyright-401">&copy; Pengadilan Tinggi Agama Makassar 2025</div>
</body>
</html> 