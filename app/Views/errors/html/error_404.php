...
<head>
    ...
    <script>
        // Mekanisme dark mode seperti di BerandaUser/Admin
        (function () {
            try {
    ...
    <style>
        ...
        /* DARK MODE: pakai class .dark-mode di html */
        html.dark-mode body {
            background: #11121a;
        }
...
<body>
    <div class="spotlight-bg">
        <!-- SVG gelombang abstrak ungu dengan animasi -->
    ...
    <div class="copyright-404">&copy; Pengadilan Tinggi Agama Makassar 2025</div>
</body>
</html>
