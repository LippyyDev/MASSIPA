...
<body>
    ...
    <div class="center-403">
        <div class="big-403">403</div>
        <div class="notfound-text">Forbidden!</div>
        <div class="desc-403">
            Anda tidak memiliki izin untuk mengakses halaman ini.
        </div>
        <button class="btn-home" onclick="window.history.length > 1 ? window.history.back() : window.location.href='/'">Kembali</button>
    </div>
    <div class="copyright-403">&copy; Pengadilan Tinggi Agama Makassar 2025</div>
</body>
</html> 