...
class Filters extends BaseFilters
{
    ...
    public array $aliases = [
        ...
        'emailQueuePump'  => \App\Filters\EmailQueuePumpFilter::class,
    ...
    public array $globals = [
        ...
        'after' => [
            ...
            'securityheaders',
            'toolbar' => ['except' => [
                'admin/exportUserSatkerWord',
                'admin/exportUserSatkerPdf',
                'admin/exportRekapKedisiplinanPdf',
                'user/rekaplaporandisiplin/export_word',
                'user/rekaplaporandisiplin/export_pdf',
            ]],
            'pagecache' => ['except' => [
                'admin/exportUserSatkerWord',
                'admin/exportUserSatkerPdf',
